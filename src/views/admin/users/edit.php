<div class="col-6 mx-auto">
    <form action="/admin/users/update" method="post">
        <input type="hidden" value="<?= $this->user->id ?>" name="id" id="">
        <div>
            <label for="name">
                name
            </label>
            <input value="<?= $this->user->name ?>" name="name" id="name" class="form-control <?php isset($_SESSION['login_form_errors']['name']['errors']) ? 'is-invalid' : '' ?>" type="text">
        ...
        <div>
            ...
            <input value="<?= $this->user->email ?>" name="email" id="email" class="form-control <?php isset($_SESSION['login_form_errors']['email']['errors']) ? 'is-invalid' : '' ?>" type="text">
        ...
        <div>
            ...
            <input <?= $this->user->is_active ? 'checked' : '' ?> name="is_active" id="is_active" value="1" class="form-check-input <?php isset($_SESSION['login_form_errors']['is_active']['errors']) ? 'is-invalid' : '' ?>" type="checkbox">
        ...
        <div>
            ...
            <input <?= $this->user->is_active ? 'checked' : '' ?> name="is_admin" id="is_admin" value="1" class="form-check-input <?php isset($_SESSION['login_form_errors']['is_admin']['errors']) ? 'is-invalid' : '' ?>" type="checkbox">
